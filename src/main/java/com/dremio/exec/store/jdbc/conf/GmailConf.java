...
@SourceType(value = "GmailARP", label = "Gmail",uiConfig = "gmail-layout.json")
public class GmailConf extends AbstractArpConf<GmailConf> {
  private static final String ARP_FILENAME = "arp/implementation/gmail-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.gmail.GmailDriver";
